...
// .replace("+", "%20");
// contentDisposition = String.format("attachment; filename*=UTF-8''%s",
// encodedFileName);
// } else {
...
// user.getFileType() != null ? user.getFileType() :
...
// public FileDownloadResult(Resource resource, MediaType mediaType, String
// contentDisposition) {
